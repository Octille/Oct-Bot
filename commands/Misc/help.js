...
module.exports = {
    ...
    async execute(message,args, cmd, client, Discord) {
        ...
        .setTitle('Help')
        .setDescription(`For additional info on each command, type "!help <command name>"`)
        ...
        if(Categories.includes(args[0].toLowerCase())) {
            ...
            .setFooter(`Dont forget to use "${process.env.prefix}" befor every command`)
        ...
        if (!COMMAND) return message.channel.send("Incorrect command refer to `!help`");
