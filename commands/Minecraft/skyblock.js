...
module.exports = {
    ...
    async execute(message, args, client) {
       ...
       /*var emoji = '';
        ...
        if (args[0] == 'inventory') {
            ...
            let msg = await message.channel.send(`Fetching stats of ${responseMojang.name}...`)
    ...
    help: 'Allows you to fetch SkyBlock statistics and find prices for various items (STILL A WIP).'
}